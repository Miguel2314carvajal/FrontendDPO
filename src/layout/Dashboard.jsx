...
const Dashboard = () => {
  ...
  // Dashboard normal para usuarios
  return (
    <div className="min-h-screen w-full bg-gray-50">
      ...
      <header className="bg-white shadow w-full">
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              <h1 className="text-3xl font-bold text-gray-900">AuditoriasApp</h1>
                        </div>
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-500">
                Bienvenido, {auth?.nombre || auth?.email || 'Usuario'}
              </span>
                        <button
                onClick={handleLogout}
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Mis Carpetas</h2>
          ...
          {folders.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Contacta al administrador para que te asigne carpetas.
              </p>
            </div>
          )}
                </div>
